...
The [Interoperability Test Bed](https://joinup.ec.europa.eu/collection/interoperability-test-bed-repository/solution/interoperability-test-bed) is pleased to announce the availability of the latest release of its common utility library.

# Usage

This library is not intended to be used in a standalone manner but rather as part of the Test Bed's **validators**. Check these out for more information:
